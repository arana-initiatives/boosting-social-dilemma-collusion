...
SPARSE_BASE_COLLUSION_PAYOFFS = np.array([[[0, 0], [0, 0]], [[0, 0], [1, 1]]], dtype=np.float32) # adds partial collusion noise, instead of singular cooperation goal
SPARSE_HETERO_COLLUSION_PAYOFFS = np.array([[[0, 0], [0, 0]], [[0, 0], [1, 2]]], dtype=np.float32) # adds partial collusion noise, instead of singular cooperation goal
