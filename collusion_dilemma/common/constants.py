...
NOISE_VAL = 0.1
TEMPERATURE_VAL = 0.12
NON_ZERO_MEAN_KERNEL = np.array([[[0, 0], [0.5, 0.5]], [[0.5, 0.5], [1, 1]]], dtype=np.float32) # kernels with period size = 2, symmetrical
ZERO_MEAN_KERNEL = np.array([[[-1, -1], [0, 0]], [[0, 0], [1, 1]]], dtype=np.float32) # kernel with negative rewards, symmetrical
