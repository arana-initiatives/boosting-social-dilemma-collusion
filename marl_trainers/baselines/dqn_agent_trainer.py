...
register_env("CollusionDilemmaEnv", lambda config: PettingZooEnv(env_creator(config)))


def run_same_policy(args, stop):
    """Use the same policy for both agents (trivial case)."""
    config = PGConfig().environment("CollusionDilemmaEnv").framework(args.framework)
...
def run_heuristic_vs_learned(args, use_lstm=False, algorithm="PG"):
    ...
    config = (
        ...
        .environment("CollusionDilemmaEnv")
